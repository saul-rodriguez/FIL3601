...
# This script was generated Wed Sep  3 16:39:57 2025 by:
#
...
flattenLayers -m cont cont_m1trm_p1trm mosvc
...
reconnect -cgnd ${CAP_GROUND} -float floatlvsnetsfile -tf nel,pel -rf \
	rpp1k1_0n -cf cmim -df p_0dnw -gf BOX -probe \
...
grow -V 0.001 mosvc g_mosvc
geom -V g_mosvc np_rp1trm - tmp_mosvc_p1trm_gdvia,11,n
ereduce -V -n2 -r tmp_mosvc_p1trm_gdvia mosvc_p1trm_gdvia
/bin/rm -f tmp_mosvc_p1trm_gdvia
...
connect -V -relocate NET np_rndiff:np_rndiff.conn np_rpdiff:np_rpdiff.conn \
	...
	rvtpCON nel_mgvia pel_mgvia rpp1k1_0n_rvia cmim_m4trm_cvia \
	mosvc_p1trm_gdvia - ntap,1,3 ptap,2,4 -
...
rex -V -m -pd -I'#' -tech \
	...
	cmim_m4trm_cvia:rpp1k1_0n_rvia:mosvc_p1trm_gdvia -rP res.mod \
	...
	rcont_p1trm_ndiff,1,t rcont_p1trm_pdiff,1,t rvia1,2,3,t \
	rvia2CON,3,4,t rvia3CON,4,5,t rvtpCON,5,6,t rvtpcm,6,t nel_mgvia,1,z \
	pel_mgvia,1,z rpp1k1_0n_rvia,1,z cmim_m4trm_cvia,5,z \
	mosvc_p1trm_gdvia,1,z - L1T0,2,I L2T0,3,I L3T0,4,I
...
geom p_rp1trm,mosvc_p1trm_gdvia - mosvc_p1trm_gdvia,1,i,1
epick -c -f floatlvsnetsfile mosvc_p1trm_gdvia mosvc_p1trm_gdvia
createLink nwtrm mosvc_nwtrm_gdvia
createLink bulk mosvc_bulk_gdvia
reconnect -V -se2 bwires.res -n NET -b BOX:BOXr mosvc \
	mosvc_p1trm_gdvia,mosvc_nwtrm_gdvia,mosvc_bulk_gdvia
...
grow -V 0.01 mosvc g_mosvc_1
grow -V -0.001 g_mosvc_1 g_dev_1
geom g_mosvc_1 sub - sub_out,01,i,2
geom g_dev_1 sub - sub_in,11,i,2
# /bin/rm -f g_dev_1
grow -V -0.001 g_mosvc_1 g_dev_2
geom g_mosvc_1 active - active_out,01,i,2
geom g_dev_2 active - active_in,11,i,2
# /bin/rm -f g_dev_2
grow -V -0.001 g_mosvc_1 g_dev_3
geom g_mosvc_1 POLY1 - POLY1_out,01,i,2
geom g_dev_3 POLY1 - POLY1_in,11,i,2
# /bin/rm -f g_dev_3
...
xreduce -V -mergecap -n NET -tech \
	...
	-rP \
	np_rp1trm.res,np_rm1trm.res,np_rm2trm.res,np_rm3trm.res,np_rm4trm.res,np_rmttrm.res,rwires.res,bwires.res,mwires.res,cwires.res,dwires.res \
	-minC 1e-17 -minCper 0.1 -cap capfile L1T0 L2T0 L3T0 nel.transnr \
	pel.transnr rpp1k1_0n.resr cmim.cpaxr p_0dnw.dpaxr BOXr
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0,L2T0,L3T0 -dxref \
	...
	-bl BOXL BOXSUB -raMu lvsres.mod,rpp1k1_0n.net rpp1k1_0n.resr -ta \
	lvsmos.mod,nel.net nel.transnr -ta lvsmos.mod,pel.net pel.transnr -pM \
